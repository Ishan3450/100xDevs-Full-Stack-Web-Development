...
function createAndAddTodo(todoTitle, todoDescription, completionStatus) {
...
app.post("/todos", function (req, res) {
  ...
  const id = createAndAddTodo(title, description, completionStatus);
...
app.put("/todos/:id", function (req, res) {
  ...
  if (id > 0 && id <= todos.length) {
    ...
    todos[id - 1].description = req.body.description;
