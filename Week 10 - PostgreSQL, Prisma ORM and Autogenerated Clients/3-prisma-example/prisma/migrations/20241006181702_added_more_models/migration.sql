/*
  ...
  - Added the required column `largeNum` to the `User` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "largeNum" BIGINT NOT NULL,
